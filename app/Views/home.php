...
<div class="row justify-content-center">
    <div class="row p-0">
        <aside class="col-lg-3 mb-3 mb-lg-0">
            <section class="card pt-3 px-3 px-md-3">
                <div class="">
                    <div class="mb-3 d-flex align-items-center">
                        <div class="mb-1">
                            <img class="rounded-circle p-1 img-thumbnail figure-img border" loading="lazy" src="https://avatars.githubusercontent.com/u/41960847?v=4" width="90" alt="">
                        </div>
                        <div class="ms-2 row">
                            <span class="fw-semibold">Tis Nquyen</span>
                            <span class="small text-muted">Website developer</span>
                        </div>
                    </div>
                    <div class="mb-3 row" style="font-size: 0.9rem;">
                        <div class="text-muted"><i class="bi bi-link-45deg me-1"></i><a href="https://t.me/tis_nquyen" class="small text-body" target="_blank">Telegram user</a></div>
                        <div class="text-muted"><i class="bi bi-link-45deg me-1"></i><a href="https://t.me/zygames" class="small text-body" target="_blank">Telegram channel</a></div>
                        <div class="text-muted"><i class="bi bi-download me-1"></i><span class="small me-1">Download module <a href="#" class="text-body" target="_blank">Drive</a></span></div>
                    </div>
                    <div class="mb-3 text-center" style="white-space: nowrap;">
                        <div class="btn-group-sm">
                            <a class="btn btn-default px-3 rounded-start-5" href="#">
                                <span>VIP KEY</span>
                            </a>
                            <a class="btn btn-default px-3 rounded-end-5" href="<?= site_url('keys/free') ?>">
                                <span>FREE KEY</span>
                            </a>
                        </div>
                    </div>
                    <div>
                        <h2 class="h6 mt-md-4 mt-0">Recent activity</h2>
                        <div class="mt-2 mb-4">
                            <div class="border border-dashed rounded-2 p-3 mt-2">
                                <p class="note mt-0 small">
        ...
        <main class="col-lg-9">
            <section class="border shadow-sm rounded overflow-hidden p-0 mb-3">
                <div class="position-relative">
                    <video class="w-100 h-auto object-fit-cover d-block" autoplay loop muted>
                    ...
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex justify-content-center align-items-center">
                        <div class="text-center text-white">
                            <h1 class="h6 display-5">Call <span class="h2">of</span> Duty MOBILE</h1>
                            <p class="lead" style="color: yellow;">PLAY FREE NOW</p>
                        </div>
                    </div>
                </div>
            </section>
<!-- 
            <section class="card border rounded pt-3 px-2 px-md-3 mb-3">
                <header class="d-flex justify-content-between mb-3">
                    <div class="d-flex">
                        <h2 class="h6 ms-1"><a href="#" class="text-body">Game Mods</a></h2>
                    </div>
                    <span class="ms-auto small"><a href="#">View More</a></span>
                </header>
                <div class="row">
                    <?php foreach ($games as $index => $game) { ?>
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            <a class="text-body border rounded overflow-hidden d-block h-100 position-relative" style="background-color: var(--bs-workflow-bg);" href="<?= site_url('details?id='.$game->id) ?>">
                                <div class="d-flex" style="padding: 0.5rem;">
                                    <div class="flex-shrink-0 me-2" style="width: 3.75rem;">
                                        <img src="<?= $game->image_url ?>" loading="lazy" class="rounded-3" width="96" height="96" aria-hidden="true" alt="Icon image" itemprop="image" data-atf="true">
                                    </div>
                                    <div style="min-width: 0;">
                                        <h2 class="h6 text-truncate" style="margin-bottom: 2px;"><?= $game->name ?></h2>
                                        <div class="small text-truncate text-muted">
                                            ...
                                            <span class="small"><?= implode(' + ', $game->modes) ?></span>
                                        </div>
                                        <div class="small text-muted text-truncate">
                                            ...
                                            <span class="small"><?= implode(', ', $game->features) ?></span>
                                        </div>
                                    </div>
                                </div>
                            </a>
