...
class Auth extends BaseController
{
    ...
    private function login_action()
    {
        ...
        if (!$this->validate($form_rules)) {
            return redirect()->route('login')->withInput()->with('msgDanger', '<strong>Failed</strong><br>' . $this->validator->listErrors());
        } else {
            $validation = Services::validation();
    ...
    public function register_action()
    {
        ...
        return redirect()->route('register')->withInput()->with('msgDanger', '<strong>Failed</strong><br>' . $this->validator->listErrors());
    }
